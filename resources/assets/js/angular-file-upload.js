	...
	function __identity(fileUploaderOptions, $rootScope, $http, $window, $timeout, FileLikeObject, FileItem, Pipeline) {
	    ...
	    var FileUploader = function () {
	        ...
	        FileUploader.prototype.removeFromQueue = function removeFromQueue(value) {
                ...
                this._onAfterRemovingFile(item);
	            item._destroy();
	         ...
	         * @param {Object} options
	         */
            FileUploader.prototype.onAfterRemovingFile = function onAfterRemovingFile(fileItem) {};
	        ...
	        */
            ...
            FileUploader.prototype._onAfterRemovingFile = function _onAfterRemovingFile(item) {
                this.onAfterRemovingFile(item);
            };
