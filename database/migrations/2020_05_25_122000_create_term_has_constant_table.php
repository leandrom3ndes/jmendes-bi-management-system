...
class CreateTermHasConstantTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('term_has_constant', function (Blueprint $table) {
            ...
            $table->primary(array('term_id', 'constant_id'),'thc_primary_keys');
        });
    }
