...
/**
 * EmbeddedSignature Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class EmbeddedSignature implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EmbeddedSignature';
    ...
    public function setKeyId($key_id)
    {
        if ((mb_strlen($key_id) > 40)) {
            throw new \InvalidArgumentException('invalid length for $key_id when calling EmbeddedSignature., must be smaller than or equal to 40.');
        }
