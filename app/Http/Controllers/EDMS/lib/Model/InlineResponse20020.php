...
class InlineResponse20020 implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        ...
        'next' => 'string',
        'previous' => 'string',
        'results' => '\OpenAPI\Client\Model\WorkflowInstanceLogEntry[]'
    ];
     ...
     * Gets results
     *
     * @return \OpenAPI\Client\Model\WorkflowInstanceLogEntry[]
     */
     ...
     * Sets results
     *
     * @param \OpenAPI\Client\Model\WorkflowInstanceLogEntry[] $results results
     *
     * @return $this
     */
