...
/**
 * SignDetached Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class SignDetached implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SignDetached';
    ...
    public function setKeyId($key_id)
    {
        if ((mb_strlen($key_id) > 40)) {
            throw new \InvalidArgumentException('invalid length for $key_id when calling SignDetached., must be smaller than or equal to 40.');
        }
