...
class DocumentType implements ModelInterface, ArrayAccess
{
    ...
    public function setDeleteTimePeriod($delete_time_period)
    {
        ...
        if (!is_null($delete_time_period) && ($delete_time_period > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $delete_time_period when calling DocumentType., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($delete_time_period) && ($delete_time_period < 0)) {
            throw new \InvalidArgumentException('invalid value for $delete_time_period when calling DocumentType., must be bigger than or equal to 0.');
        }
    ...
    {
        $allowedValues = $this->getDeleteTimeUnitAllowableValues();
        if (!is_null($delete_time_unit) && !in_array($delete_time_unit, $allowedValues, false)) {
    ...
    public function setLabel($label)
    {
        if ((mb_strlen($label) > 96)) {
            throw new \InvalidArgumentException('invalid length for $label when calling DocumentType., must be smaller than or equal to 96.');
        }
    ...
    public function setTrashTimePeriod($trash_time_period)
    {
        ...
        if (!is_null($trash_time_period) && ($trash_time_period > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $trash_time_period when calling DocumentType., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($trash_time_period) && ($trash_time_period < 0)) {
            throw new \InvalidArgumentException('invalid value for $trash_time_period when calling DocumentType., must be bigger than or equal to 0.');
        }
