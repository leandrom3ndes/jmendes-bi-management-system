...
class InlineResponse20016 implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        ...
        'next' => 'string',
        'previous' => 'string',
        'results' => '\OpenAPI\Client\Model\ResolvedSmartLinkDocument[]'
    ];
     ...
     * Gets results
     *
     * @return \OpenAPI\Client\Model\ResolvedSmartLinkDocument[]
     */
     ...
     * Sets results
     *
     * @param \OpenAPI\Client\Model\ResolvedSmartLinkDocument[] $results results
     *
     * @return $this
     */
