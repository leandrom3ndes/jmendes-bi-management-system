...
class InlineResponse20014 implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        ...
        'next' => 'string',
        'previous' => 'string',
        'results' => '\OpenAPI\Client\Model\IndexInstanceNode[]'
    ];
     ...
     * Gets results
     *
     * @return \OpenAPI\Client\Model\IndexInstanceNode[]
     */
     ...
     * Sets results
     *
     * @param \OpenAPI\Client\Model\IndexInstanceNode[] $results results
     *
     * @return $this
     */
