...
class Tag implements ModelInterface, ArrayAccess
{
    ...
    public function setColor($color)
    {
        if ((mb_strlen($color) > 7)) {
            throw new \InvalidArgumentException('invalid length for $color when calling Tag., must be smaller than or equal to 7.');
        }
        if ((!preg_match("/^#?((?:[0-F]{3}){1,2})$/", $color))) {
            throw new \InvalidArgumentException("invalid value for $color when calling Tag., must conform to the pattern /^#?((?:[0-F]{3}){1,2})$/.");
        }
    ...
    public function setLabel($label)
    {
        if ((mb_strlen($label) > 128)) {
            throw new \InvalidArgumentException('invalid length for $label when calling Tag., must be smaller than or equal to 128.');
        }
