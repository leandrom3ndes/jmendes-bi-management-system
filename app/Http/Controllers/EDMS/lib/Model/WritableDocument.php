...
/**
 * WritableDocument Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class WritableDocument implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'WritableDocument';
    ...
    public function setLabel($label)
    {
        if (!is_null($label) && (mb_strlen($label) > 255)) {
            throw new \InvalidArgumentException('invalid length for $label when calling WritableDocument., must be smaller than or equal to 255.');
        }
    ...
    public function setLanguage($language)
    {
        if (!is_null($language) && (mb_strlen($language) > 8)) {
            throw new \InvalidArgumentException('invalid length for $language when calling WritableDocument., must be smaller than or equal to 8.');
        }
