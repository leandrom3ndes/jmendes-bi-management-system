...
class NotificationsApi
{
    ...
    {
        list($response) = $this->notificationsListWithHttpInfo($page);
        return $response;
    }
     ...
     */
    public function notificationsListWithHttpInfo($page = null)
    {
        $request = $this->notificationsListRequest($page);
     ...
     */
    public function notificationsListAsync($page = null)
    {
        return $this->notificationsListAsyncWithHttpInfo($page)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function notificationsListAsyncWithHttpInfo($page = null)
    {
        $returnType = '\OpenAPI\Client\Model\InlineResponse20030';
        $request = $this->notificationsListRequest($page);
     ...
     */
    protected function notificationsListRequest($page = null)
    {
