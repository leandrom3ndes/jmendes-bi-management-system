...
class EventsApi
{
     ...
     */
    public function eventsList($page = null)
    {
        list($response) = $this->eventsListWithHttpInfo($page);
        return $response;
    }
     ...
     */
    public function eventsListWithHttpInfo($page = null)
    {
        $request = $this->eventsListRequest($page);
     ...
     */
    public function eventsListAsync($page = null)
    {
        return $this->eventsListAsyncWithHttpInfo($page)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function eventsListAsyncWithHttpInfo($page = null)
    {
        $returnType = '\OpenAPI\Client\Model\InlineResponse20023';
        $request = $this->eventsListRequest($page);
     ...
     */
    protected function eventsListRequest($page = null)
    {
