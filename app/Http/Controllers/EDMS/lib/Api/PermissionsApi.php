...
class PermissionsApi
{
     ...
     */
    public function permissionsList($page = null)
    {
        list($response) = $this->permissionsListWithHttpInfo($page);
        return $response;
    }

    /**
     * Operation permissionsListWithHttpInfo
     *
     * @param  int $page A page number within the paginated result set. (optional)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     ...
     */
    public function permissionsListWithHttpInfo($page = null)
    {
        $request = $this->permissionsListRequest($page);
    ...
    /**
     * Operation permissionsListAsync
     *
     *
     *
     * @param  int $page A page number within the paginated result set. (optional)
     ...
     */
    public function permissionsListAsync($page = null)
    {
        return $this->permissionsListAsyncWithHttpInfo($page)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation permissionsListAsyncWithHttpInfo
     *
     *
     *
     * @param  int $page A page number within the paginated result set. (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function permissionsListAsyncWithHttpInfo($page = null)
    {
        $returnType = '\OpenAPI\Client\Model\InlineResponse20033';
        $request = $this->permissionsListRequest($page);
    ...
    /**
     * Create request for operation 'permissionsList'
     *
     * @param  int $page A page number within the paginated result set. (optional)
     *
     * @throws \InvalidArgumentException
     ...
     */
    protected function permissionsListRequest($page = null)
    {
