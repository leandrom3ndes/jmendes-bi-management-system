...
class TemplatesApi
{
     ...
     */
    public function templatesList($page = null)
    {
        list($response) = $this->templatesListWithHttpInfo($page);
        return $response;
    }
     ...
     */
    public function templatesListWithHttpInfo($page = null)
    {
        $request = $this->templatesListRequest($page);
     ...
     */
    public function templatesListAsync($page = null)
    {
        return $this->templatesListAsyncWithHttpInfo($page)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function templatesListAsyncWithHttpInfo($page = null)
    {
        $returnType = '\OpenAPI\Client\Model\InlineResponse20040';
        $request = $this->templatesListRequest($page);
     ...
     */
    protected function templatesListRequest($page = null)
    {
     ...
     */
    public function templatesRead($name)
    {
        list($response) = $this->templatesReadWithHttpInfo($name);
        return $response;
    }
     ...
     */
    public function templatesReadWithHttpInfo($name)
    {
        $request = $this->templatesReadRequest($name);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function templatesReadAsync($name)
    {
        return $this->templatesReadAsyncWithHttpInfo($name)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function templatesReadAsyncWithHttpInfo($name)
    {
        $returnType = '\OpenAPI\Client\Model\Template';
        $request = $this->templatesReadRequest($name);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function templatesReadRequest($name)
    {
        // verify the required parameter 'name' is set
        if ($name === null || (is_array($name) && count($name) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $name when calling templatesRead'
            );
        }
